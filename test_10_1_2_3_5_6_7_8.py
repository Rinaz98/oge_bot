...
class FSMTest_10_1_2_3_5_6_7_8(StatesGroup):
    name = State()
    grade = State()
    question_1 = State()
    question_2 = State()
...
async def set_start(message: types.Message):
    await FSMTest_10_1_2_3_5_6_7_8.name.set()
...
async def get_student_name(message: types.Message, state: FSMContext):
    ...
    await FSMTest_10_1_2_3_5_6_7_8.next()
...
def register_handlers_test_10_1_2_3_5_6_7_8(dp: Dispatcher):
    dp.register_message_handler(set_start, commands='test8', state=None)
    dp.register_message_handler(get_student_name, state=FSMTest_10_1_2_3_5_6_7_8.name)
    dp.register_message_handler(cancel_test, Text(equals='отмена', ignore_case=True), state="*")
    dp.register_message_handler(get_grade, state=FSMTest_10_1_2_3_5_6_7_8.grade)
    dp.register_message_handler(quest_n1, state=FSMTest_10_1_2_3_5_6_7_8.question_1)
    dp.register_message_handler(quest_n2, state=FSMTest_10_1_2_3_5_6_7_8.question_2)
    dp.register_message_handler(quest_n3, state=FSMTest_10_1_2_3_5_6_7_8.question_3)
    dp.register_message_handler(quest_n4, state=FSMTest_10_1_2_3_5_6_7_8.question_4)
    dp.register_message_handler(quest_n5, state=FSMTest_10_1_2_3_5_6_7_8.question_5)
    dp.register_message_handler(quest_n6, state=FSMTest_10_1_2_3_5_6_7_8.question_6)
    dp.register_message_handler(quest_n7, state=FSMTest_10_1_2_3_5_6_7_8.question_7)
    dp.register_message_handler(quest_n8, state=FSMTest_10_1_2_3_5_6_7_8.question_8)
    dp.register_message_handler(quest_n9, state=FSMTest_10_1_2_3_5_6_7_8.question_9)
    dp.register_message_handler(quest_n10, state=FSMTest_10_1_2_3_5_6_7_8.question_10)
    dp.register_message_handler(quest_n11, state=FSMTest_10_1_2_3_5_6_7_8.question_11)
