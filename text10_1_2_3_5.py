...
from questions import type_10_quest, type_1_quest, type_2_quest, type_3_quest, type_5_quest
from aiogram.dispatcher.filters import Text


class FSMTest10_1_2_3_5(StatesGroup):
    name = State()
    grade = State()
    question_1 = State()
    question_2 = State()
...
async def set_start(message: types.Message):
    await FSMTest10_1_2_3_5.name.set()
...
def register_handlers_test_10_1_2_3_5(dp: Dispatcher):
    dp.register_message_handler(set_start, commands='test5', state=None)
    dp.register_message_handler(get_student_name, state=FSMTest10_1_2_3_5.name)
    dp.register_message_handler(cancel_test, Text(equals='отмена', ignore_case=True), state="*")
    dp.register_message_handler(get_grade, state=FSMTest10_1_2_3_5.grade)
    dp.register_message_handler(quest_n1, state=FSMTest10_1_2_3_5.question_1)
    dp.register_message_handler(quest_n2, state=FSMTest10_1_2_3_5.question_2)
    dp.register_message_handler(quest_n3, state=FSMTest10_1_2_3_5.question_3)
    dp.register_message_handler(quest_n4, state=FSMTest10_1_2_3_5.question_4)
    dp.register_message_handler(quest_n5, state=FSMTest10_1_2_3_5.question_5)
    dp.register_message_handler(quest_n6, state=FSMTest10_1_2_3_5.question_6)
    dp.register_message_handler(quest_n7, state=FSMTest10_1_2_3_5.question_7)
    dp.register_message_handler(quest_n8, state=FSMTest10_1_2_3_5.question_8)
    dp.register_message_handler(quest_n9, state=FSMTest10_1_2_3_5.question_9)
    dp.register_message_handler(quest_n10, state=FSMTest10_1_2_3_5.question_10)
    dp.register_message_handler(quest_n11, state=FSMTest10_1_2_3_5.question_11)